class Cylinder{
    ...
    render() {
      ...
      for (var angle = 0; angle < 360; angle += angleStep){
        ...
        let pt3 = [centerPt_1[0]+vec3[0], centerPt_1[1]+vec3[1]];
        let pt4 = [centerPt_1[0]+vec4[0], centerPt_1[1]+vec4[1]];

        //drawTriangle3D( [xy[0], xy[1], pt1[0], pt1[1], pt2[0], pt2[1], 1,0,0] );
